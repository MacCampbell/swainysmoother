...
setwd("/home/mac/swainysmoother/exampleData/")

data1<-read.table("M021514_M209_1G.dat")
ranges1<-data1$V3-data1$V2
data1$ranges<-data1$V3-data1$V2

data2<-read.table("M021516_M209_2A.dat")
ranges2<-data2$V3-data2$V2
data2$ranges<-data2$V3-data2$V2

data3<-read.table("M021644_M210_6A.dat")
ranges3<-data3$V3-data3$V2
data3$ranges<-data3$V3-data3$V2

data4<-read.table("M021646_M210_6C.dat")
